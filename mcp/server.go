...
func (s *MCPServer) registerTools() {
	...
	s.addTool(mcp.NewTool("list_runs",
		...
		mcp.WithAny("workflow_id",
			mcp.Description("Optional: workflow ID, workflow name, or workflow file path (e.g., '12345678', 'CI', or '.github/workflows/ci.yml') to filter by"),
		),
